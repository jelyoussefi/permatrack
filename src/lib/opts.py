...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--dataset', default='coco',
                            ...
                            'available datasets')
    self.parser.add_argument('--dataset1', default='coco',
                             help='first dataset for multi-dataset training')
    self.parser.add_argument('--dataset2', default='coco',
                             help='second dataset for multi-dataset training')
    ...
    self.parser.add_argument('--is_recurrent', action='store_true')
    ...
    self.parser.add_argument('--input_len', type=int, default=2, 
                             help='Number of frames.')                         
    self.parser.add_argument('--dataset_version', default='')
    self.parser.add_argument('--only_ped', action='store_true',
                             help='Only supervise pedestrians')
    self.parser.add_argument('--center_dist_thresh', type=int, default=1, 
                             help='Distance between centers used to handle centr overlaps during train.') 
    self.parser.add_argument('--const_v_over_occl', action='store_true',
                             help='Propagate objects behind occlusions with a cosntant velocity')
    ...
    self.parser.add_argument('--batch_size', type=int, default=32,
                             help='batch size')
    self.parser.add_argument('--batch_split_factor', type=int, default=-1,
                             help='split the batch into the given number of independent forward passes')
    self.parser.add_argument('--master_batch_size', type=int, default=-1,
                             help='batch size on the master gpu.')
    self.parser.add_argument('--num_iters', type=int, default=-1,
                             help='default: #samples / batch_size.')
    self.parser.add_argument('--num_val_iters', type=int, default=-1,
                             help='default: #samples.')
    ...
    self.parser.add_argument('--nl', action='store_true')
    self.parser.add_argument('--sup_invis', action='store_true', 
                             help='track objects behind occlusions')
    self.parser.add_argument('--occlusion_thresh', type=float, default=0.1,
                             help='degree of occlusion to ignore object')
    self.parser.add_argument('--visibility_thresh', type=float, default=0.01,
                             help='degree of occlusion to consider fully invisible')
    ...
    self.parser.add_argument('--occl_len_mult', type=int, default=1, help='')
    self.parser.add_argument('--diff_dissocl_weighting', action='store_true')
    self.parser.add_argument('--no_temp_flip', action='store_true')
    self.parser.add_argument('--const_v_2d', action='store_true')
    self.parser.add_argument('--nu', action='store_true')
    ...
    self.parser.add_argument('--stream_test', action='store_true')
    self.parser.add_argument('--write_to_file', action='store_true')
    self.parser.add_argument('--vis_hms', action='store_true',
    ...
    self.parser.add_argument('--min_frame_dist', type=int, default=1)
    ...
    self.parser.add_argument('--visibility_thresh_eval', type=float, default=0.4)
  ...
  def init(self, args=''):
    ...
    default_dataset_info = {
      ...
      'tracking,ddd': 'nuscenes_tracking'
    }
    opt = self.parse()
